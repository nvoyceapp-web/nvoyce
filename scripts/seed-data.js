...
const dummyDocuments = [
  ...
  },
  {
    ...
    price: 500,
    status: 'sent',
    created_at: new Date(2026, 2, 25).toISOString(), // ~12 days old
    generated_content: {
  ...
  },
  {
    ...
    price: 2800,
    status: 'sent',
    created_at: new Date(2026, 2, 15).toISOString(), // ~22 days old - overdue
    generated_content: {
...
async function seedData() {
  try {
    ...
    console.log('\nDocument summary:');
    console.log('- 4 invoices (paid, viewed, sent, draft)');
    console.log('- 2 proposals (sent, draft)');
    console.log('- Includes overdue invoice (Jessica Lee - 22 days old)');
    console.log('- Includes 12-day invoice (David Park - reminder eligible)');
